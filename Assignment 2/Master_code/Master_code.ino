...
//TODO PArte aggiuntiva per meteo
...
#define WEATHER_API_READ_INTERVAL 5000  // read weather api value each 5000 ms
...
String header;  //TODO capire se vienee usata
...
void storeCurrentWeather() {
  static unsigned long lastweatherApiRead = millis();

  if (millis() - lastweatherApiRead > WEATHER_API_READ_INTERVAL) {
    ...
    //todo capire se si può recuperare la location in automatico
